...
namespace Zw_BugTracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(HttpPostedFileBase image, RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                //var timezones = TimeZoneInfo.GetSystemTimeZones();
                //model.TimeZone = new SelectList(timezones, "Id", "Id");
        ...
        public async Task<ActionResult> DemoLogin(string Role)
        {
            ...
            {
                case "DemoAdminEmail":
                    demoUserName = WebConfigurationManager.AppSettings["DemoAdminEmail"];
                    break;
                case "DemoPMEmail":
                    demoUserName = WebConfigurationManager.AppSettings["DemoPMEmail"];
                    break;
                case "DemoDevEmail":
                    demoUserName = WebConfigurationManager.AppSettings["DemoDevEmail"];
                    break;
                case "DemoSubEmail":
                    demoUserName = WebConfigurationManager.AppSettings["DemoSubEmail"];
                    break;
                default:
                    break;
            }
