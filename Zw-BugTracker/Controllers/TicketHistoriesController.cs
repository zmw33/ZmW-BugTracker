...
namespace Zw_BugTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UserId,Property,OldValue,NewValue,Chnaged")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,UserId,Property,OldValue,NewValue,Chnaged")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
