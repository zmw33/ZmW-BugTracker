...
namespace CustomHTMLHelpers
{
    ...
    {
        public static IHtmlString ToUserTime(this HtmlHelper helper, DateTime ModelTime, string timezone)
        {
        ...
        public static IHtmlString ToUserTime(this HtmlHelper helper, DateTime ModelTime, string timezone, string ToStringFormat)
        {
            var timezoneId = TimeZoneInfo.FindSystemTimeZoneById(timezone);
            var newTime = TimeZoneInfo.ConvertTime(ModelTime, timezoneId);
