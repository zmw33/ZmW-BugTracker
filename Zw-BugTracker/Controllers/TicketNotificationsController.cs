...
namespace Zw_BugTracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Body,TicketId,RecipientId,SenderId")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Body,TicketId,RecipientId,SenderId")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
